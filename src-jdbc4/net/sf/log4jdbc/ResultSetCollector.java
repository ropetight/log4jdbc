...
/**
 * Collect a result set, ultimately available from getRow(). A ResultSetSpy instance may call a ResultSetCollector
 * instance's methodReturned and preMethod as and when appropriate. The ResultSetCollector is then expected to build a
 * simple representation of the rows and columns in getRow()/getColumnCount()/getColumnName().
 *
