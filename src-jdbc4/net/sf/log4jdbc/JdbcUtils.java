...
/**
 * Generic utility methods for working with JDBC. Mainly for internal use within the [spring] framework, but also useful
 * for custom JDBC access code. Copied from Spring JdbcUtils by Tim Azzopardi for log4jdbc
 *
