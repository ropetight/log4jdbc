...
/**
 * Delegates Spy events to a logger. This interface is used for all logging activity used by log4jdbc and hides the
 * specific implementation of any given logging system from log4jdbc.
 *
 * @author Arthur Blake
 */
